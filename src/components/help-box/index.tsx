...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Room Creator'];
  const customerRoles: string[] = ['General User'];
  const tenantRoles: string[] = ['Room Creator', 'Music Selector'];
  const addOns: string[] = [];
  const applicationName = `Shiver Music App`;
